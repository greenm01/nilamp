...
//
// Gated behind the `dsp-tests` Cargo feature: run with
// `cargo test --features dsp-tests`.  Without the feature the build.rs
// emits empty stubs for dsp/tests/*.rs so the rest of the workspace
// builds quickly during DSP iteration.

#![cfg(feature = "dsp-tests")]
